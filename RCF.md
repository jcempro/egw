...
- `RCF-IF-ISSUE-009` Issue de indicação de fonte DEVE aceitar uma ou mais publicações, cada uma com uma ou mais URLs, em texto livre, Markdown, JSON ou YAML simples. O template DEVE orientar por exemplos curtos e diretos, sem exigir conhecimento técnico nem tornar um formato único obrigatório.
